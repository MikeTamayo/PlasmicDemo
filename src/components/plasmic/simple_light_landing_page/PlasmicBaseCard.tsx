...
import sty from "./PlasmicBaseCard.module.css"; // plasmic-import: qxPEdg9gbaUkFK/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__rKfWy, {
          [sty.freeBoxlong__rKfWy9U00J]: hasVariant($state, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      {(hasVariant($state, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__vtbot, {
            [sty.freeBoxlong__vtbot9U00J]: hasVariant($state, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__zqG)}
                role={"img"}
              />
            ),
