...
import sty from "./PlasmicHeader.module.css"; // plasmic-import: sOsmmf3o-zZuL/css
...
function PlasmicHeader__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <LogoIcon
          className={classNames(projectcss.all, sty.svg__bhtDo)}
          role={"img"}
        />
      </a>
      ...
      >
        <Button
          className={classNames("__wab_instance", sty.button__yhdh8)}
        ...
        <Button
          className={classNames("__wab_instance", sty.button__hcVuv)}
          color={"clear" as const}
          link={`/pricing`}
          size={"compact" as const}
        >
        ...
        <Button
          className={classNames("__wab_instance", sty.button__taOy3)}
          color={"clear" as const}
          size={"compact" as const}
        >
          {"Sign in"}
        ...
        {(hasVariant(globalVariants, "screen", "mobile") ? true : true) ? (
          <Button
            className={classNames("__wab_instance", sty.button__zcEtX)}
            endIcon={
              <RightArrowIcon
                className={classNames(projectcss.all, sty.svg__lPyWs)}
                role={"img"}
              />
            }
            showEndIcon={true}
