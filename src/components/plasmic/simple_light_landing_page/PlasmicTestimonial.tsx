...
import Avatar from "../../Avatar"; // plasmic-import: Ce1fecoZqbnNd4/component
...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: s9wHHSz97UqhRG/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: 2wnKvgUwSa6MVJ/icon
import profilepicDeyLCarY91Yk3 from "./images/profilepic.png"; // plasmic-import: deyLCar-Y91yk3/picture
  ...
  return (
    ...
    >
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__qQwvz)}
      >
        <div
          className={classNames(
            projectcss.all,
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__ikEzI)}
        >
          <div
            className={classNames(
              projectcss.all,
