...
import sty from "./PlasmicFeatureCard.module.css"; // plasmic-import: 45TRcn8kBZSuL/css
  ...
  return (
    ...
    >
      {(hasVariant($state, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox___2I1Tw, {
            [sty.freeBoxlong___2I1TwupH3B]: hasVariant($state, "long", "long")
          })}
        >
          <div
            className={classNames(projectcss.all, sty.freeBox__cdtwK, {
              [sty.freeBoxlong__cdtwKupH3B]: hasVariant($state, "long", "long")
            })}
          >
            {p.renderPlasmicSlot({
              defaultContents: (
                <svg
                  className={classNames(projectcss.all, sty.svg___6B2YY)}
                  role={"img"}
                />
              ),
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__hfExu, {
          [sty.freeBoxlong__hfExuupH3B]: hasVariant($state, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
      ...
      {(hasVariant($state, "long", "long") ? true : true) ? (
        <div
          className={classNames(projectcss.all, sty.freeBox__cmlec, {
            [sty.freeBoxlong__cmlecupH3B]: hasVariant($state, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__qI00G)}
                role={"img"}
              />
            ),
