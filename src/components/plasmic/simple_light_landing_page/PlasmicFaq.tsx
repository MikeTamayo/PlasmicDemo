...
import sty from "./PlasmicFaq.module.css"; // plasmic-import: NW1qZbORuhRoU6/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__pKopl)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__oDvDe)}>
          <div className={classNames(projectcss.all, sty.freeBox__acnmJ)}>
            {p.renderPlasmicSlot({
