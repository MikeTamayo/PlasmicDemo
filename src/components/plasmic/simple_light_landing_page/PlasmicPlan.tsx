...
import BaseCard from "../../BaseCard"; // plasmic-import: qxPEdg9gbaUkFK/component
...
import sty from "./PlasmicPlan.module.css"; // plasmic-import: sHiExf-SWIih0b/css
...
function PlasmicPlan__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__zOllw)}>
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__nNDez)}
        >
          {p.renderPlasmicSlot({
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.freeBox__zdLE)}
              >
                <Bullet
                  className={classNames("__wab_instance", sty.bullet__jalfV)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__jpWqo)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__jvLqn)}
                />
              </p.Stack>
            ),
          ...
          <div className={classNames(projectcss.all, sty.freeBox__sYrpg)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button___1IJbo)}
